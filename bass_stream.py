...
from .bass_module import bass_module, Bass, bass_aac_module
from .bass_module import func_type, func_aac_type
...
BASS_MP4_StreamCreateFile = func_aac_type(
	HSTREAM,
	ctypes.c_bool,
	ctypes.c_void_p,
	QWORD,
	QWORD,
	ctypes.c_ulong)(('BASS_MP4_StreamCreateFile', bass_aac_module))
BASS_AAC_StreamCreateFile = func_aac_type(
	HSTREAM,
	ctypes.c_bool,
	ctypes.c_void_p,
	QWORD,
	QWORD,
	ctypes.c_ulong)(('BASS_AAC_StreamCreateFile', bass_aac_module))
...
class BassStream:
	...
	def CreateFile(cls, mem, file, offset=0, length=0, flags=0):
		...
		for stream_type in [BASS_StreamCreateFile, BASS_MP4_StreamCreateFile, BASS_AAC_StreamCreateFile]:
			handle = stream_type(mem, file, offset, length, flags)
