...
BASS_ChannelSetAttribute = func_type(QWORD,
                                     ctypes.c_ulong,
                                     ctypes.c_ulong, ctypes.c_float)(('BASS_ChannelSetAttribute', bass_module))
...
class BassChannel:
    ...
    @classmethod
    def ChannelSetAttribute(cls, stream_handle, volume):
        return BASS_ChannelSetAttribute(stream_handle, 2, volume)
